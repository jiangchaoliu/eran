...
parser.add_argument('--skipnum', type=int, default=0, help='skip main data')
parser.add_argument('--endnum', type=int, default=100, help='skip main data')
...
if dataset=='acasxu':
    ...
    for test in tests:
        ...
        f.write(str(total_images-1)+" "+str(mindelta)+" "+str((end-start)/c)+"\n")
        f.close()
